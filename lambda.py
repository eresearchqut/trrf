...
def _set_env_variables(parameter_envs):
    ...
    response = ssm.get_parameters(Names=list(parameter_envs.keys()), WithDecryption=True)
...
from rdrf.services.io.notifications.longitudinal_followups import send_longitudinal_followups  # noqa: E402
