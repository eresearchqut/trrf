# Generated by Django 2.1.9 on 2019-06-19 02:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_next_stages', models.ManyToManyField(related_name='prev_stages', to='patients.PatientStage')),
                ('allowed_prev_stages', models.ManyToManyField(related_name='next_stages', to='patients.PatientStage')),
            ],
        ),
        migrations.AddField(
