Feature: Date of migration field
  ...
  Scenario: Curator navigates to patient demographics, fills in date of migration
    ...
    When I expand the "Patients Personal Details" section
    And I enter value "23-02-1998" for form "Demographics" section "Patients Personal Details" cde "Date of migration"
