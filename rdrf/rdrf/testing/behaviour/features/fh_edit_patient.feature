Feature: Add a patient and add an address
  ...
  Scenario: Curator user adds and edits a patient
    ...
    And I select "FH Registry" from "Registry"
    And I select "fh Fiona Stanley Hospital" from "Working Group"
    ...
    And I expand the "Patient Address" section
    And I choose with wait "Victoria" from "State" in "Patient Address" section "1"
