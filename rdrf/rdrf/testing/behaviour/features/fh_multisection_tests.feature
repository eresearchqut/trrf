Feature: User operates on multisection items.
  ...
  Scenario: Add multiple items to a multisection.
    ...
    When I upload file "/app/authors.txt" for multisection "Carotid Ultrasonography" cde "Report" in item 1
    ...
    When I upload file "/app/license.txt" for multisection "Carotid Ultrasonography" cde "Report" in item 2
    And I click the "Save" button
    Then I should see "Patient John SMITH saved successfully"
    And I expand the "Carotid Ultrasonography" section
    ...
    And I click the "Save" button
    And I expand the "Carotid Ultrasonography" section
    Then I should not be able to download "authors.txt"
    And I should be able to download "license.txt"
