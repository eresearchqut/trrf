SECURITY_WHITELISTED_URLS = (
    ...
    "admin:trials_nofonearm_add",
    "admin:trials_nofonearm_autocomplete",
    "admin:trials_nofonearm_change",
    "admin:trials_nofonearm_changelist",
    "admin:trials_nofonearm_delete",
    "admin:trials_nofonearm_history",
    "admin:trials_nofonecycle_add",
    "admin:trials_nofonecycle_autocomplete",
    "admin:trials_nofonecycle_change",
    "admin:trials_nofonecycle_changelist",
    "admin:trials_nofonecycle_delete",
    "admin:trials_nofonecycle_history",
    "admin:trials_nofoneperiod_add",
    "admin:trials_nofoneperiod_autocomplete",
    "admin:trials_nofoneperiod_change",
    "admin:trials_nofoneperiod_changelist",
    "admin:trials_nofoneperiod_delete",
    "admin:trials_nofoneperiod_history",
    "admin:trials_nofonetreatment_add",
    "admin:trials_nofonetreatment_autocomplete",
    "admin:trials_nofonetreatment_change",
    "admin:trials_nofonetreatment_changelist",
    "admin:trials_nofonetreatment_delete",
    "admin:trials_nofonetreatment_history",
    "admin:trials_nofonetrial_add",
    "admin:trials_nofonetrial_autocomplete",
    "admin:trials_nofonetrial_change",
    "admin:trials_nofonetrial_changelist",
    "admin:trials_nofonetrial_delete",
    "admin:trials_nofonetrial_history",
    ...
    "proms",
    "proms:proms_delete",
    "proms:proms_download",
    "proms:survey_assignments",
    "proms:survey_endpoint",
    "proms_clinical_view",
    "proms_completed",
    "proms_landing_page",
    "promsqrcode",
