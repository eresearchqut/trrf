...
from rdrf.models.definition.models import CommonDataElement, ContextFormGroup
...
class PromsProcessor:
    ...
    def _update_proms_fields(self, survey_request, survey_data):
        ...
        if context_form_group is None and self.registry_model.has_feature(RegistryFeatures.CONTEXTS):
