...
def set_abbreviated_name_on_cfg(apps, schema_editor):
    ...
    for idx, cfg in enumerate(cfgs):
        cfg.abbreviated_name = f'CFG-{idx}'
        cfg.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='contextformgroup',
            name='abbreviated_name',
            field=models.CharField(help_text='Abbreviated name for identification of CFG in other contexts (e.g. reports)', max_length=100, validators=[django.core.validators.RegexValidator(regex='^[A-Za-z\\s-]+$')]),
        ),
        migrations.AlterField(
            model_name='registryform',
            name='abbreviated_name',
            field=models.CharField(help_text='Abbreviated name for identification of this RegistryForm in other contexts (e.g. reports)', max_length=100, validators=[django.core.validators.RegexValidator(regex='^[A-Za-z\\s-]+$')]),
        ),
        migrations.AlterField(
            model_name='section',
            name='abbreviated_name',
            field=models.CharField(help_text='Abbreviated name for identification of this Section in other contexts (e.g. reports)', max_length=100, validators=[django.core.validators.RegexValidator(regex='^[A-Za-z\\s-]+$')]),
        ),
        migrations.AlterField(
            model_name='commondataelement',
            name='abbreviated_name',
            field=models.CharField(help_text='Abbreviated name for identification of this CDE in other contexts (e.g. reports)', max_length=100, validators=[django.core.validators.RegexValidator(regex='^[A-Za-z\\s-]+$')]),
        )
    ]
