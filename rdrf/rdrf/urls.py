...
from rdrf.auth.views import login_assistance_confirm, QRGeneratorView, SetupView, DisableView, TRRFLoginView
...
two_factor_auth_urls = [
    re_path(r'^account/login/?$', TRRFLoginView.as_view(), name='login'),
