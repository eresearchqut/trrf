...
docker-compose -f docker-compose-prod.yml run uwsgi /docker-entrypoint.sh django-admin collectstatic
docker-compose -f docker-compose-prod.yml run uwsgi /docker-entrypoint.sh django-admin migrate
