...
export TRRF_NGINX_PROXY_IMAGE=$(aws ssm get-parameter --name /app/dev/TRRF_NGINX_PROXY_IMAGE | jq -r .Parameter.Value)
...
export NGINX_DOCKER_IMAGE="${ECR_URL}/${TRRF_NGINX_PROXY_IMAGE}"
